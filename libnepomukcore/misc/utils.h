...
namespace Nepomuk {
    ...
    namespace Utils {
         ...
         * \since 4.6
         */
        NEPOMUK_EXPORT QString formatPropertyValue( const Nepomuk::Types::Property& property,
         ...
         * \since 4.6
         */
        NEPOMUK_EXPORT Nepomuk::Resource createCopyEvent( const KUrl& src,
                                                          const KUrl& dest,
         ...
         * \since 4.6
         */
        NEPOMUK_EXPORT void finishCopyEvent( Nepomuk::Resource& eventResource, const QDateTime& endTime );
    }
}
